...
- `Win11_checking_static_ip.png` — GUI view of static IP settings  
- `win11_static_ip_config.png` — Adapter configuration  
- `Win11_ipconfig_output.png` — PowerShell confirmation of static IP
...
- `Ubuntu_Server_editing_static_ip_yaml_file.png` — Netplan config for static IP  
- `Ubuntu_Server_apply_static_ip.png` — Applying network changes  
