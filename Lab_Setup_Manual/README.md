...
- [**Lab Architecture Diagram**](00_Lab_Architecture.md) — Visual topology of the 4-VM lab environment.
- [**IP Address Map**](01_IP_Address_Map.md) — Static IP assignments for all nodes (DC01, Splunk, Win11, Kali).
