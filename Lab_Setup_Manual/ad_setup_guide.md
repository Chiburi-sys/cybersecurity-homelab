...
- [x] Windows Server has static IP 192.168.50.5
- [x] Server renamed to DC01
- [x] AD DS role installed and server promoted
- [x] Domain `cybersec.local` is operational
- [x] OUs created (IT, HR, Finance)
- [x] User accounts created with appropriate group memberships
- [x] SPN set on svc_sql for Kerberoasting lab
- [ ] Windows 11 joined to the domain *(blocked — Windows 11 Home does not support domain join)*
- [x] Splunk Forwarder on DC sending logs
- [x] Kali can reach the DC (ping 192.168.50.5)
...
![DC01 Active Directory Users and Computers](../Screenshots/Win_Server22/DC01_AD_users_IT_OU.png)

---

## 📸 Screenshots

All screenshots are stored in `Screenshots/Win_Server22/`:

| Screenshot | Description |
|------------|-------------|
| `DC01_network_adapter_properties.png` | Ethernet adapter settings |
| `DC01_static_ip_configuration.png` | Static IP 192.168.50.5 configured |
| `DC01_ADDS_role_installation.png` | AD DS role installation progress |
| `DC01_domain_promotion_prerequisites.png` | Prerequisites check passed |
| `DC01_ADDS_server_manager.png` | Server Manager showing AD DS |
| `DC01_AD_create_OU.png` | Creating Organizational Unit |
| `DC01_AD_OUs_created_IT_HR_Finance.png` | IT, HR, Finance OUs in tree |
| `DC01_AD_users_IT_OU.png` | IT OU — Stacy Bostick, John Smith, SQL Service |
| `DC01_AD_users_HR_OU.png` | HR OU — Jane Doe |
| `DC01_AD_users_Finance_OU.png` | Finance OU — Bob Wilson |
| `DC01_setspn_command.png` | setspn command for svc_sql |
| `DC01_setspn_svc_sql_registered.png` | SPN successfully registered |
| `DC01_Splunk_forwarder_installing.png` | Universal Forwarder installation |
| `DC01_Splunk_forwarder_inputs_conf.png` | inputs.conf configuration |
| `DC01_Splunk_forwarder_outputs_conf.png` | outputs.conf → 192.168.50.10:9997 |
